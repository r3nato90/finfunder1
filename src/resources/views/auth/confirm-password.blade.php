                                ...
                                <div class="row g-3">
                                    <div class="col-12">
                                        <div class="form-inner">
                                            ...
                                            <input type="password" id="password" name="password" placeholder="{{ __('Enter Password') }}" required>
                                        </div>
                                    </div>

                                    <div class="col-12">
                                        <button class="i-btn btn--lg btn--primary w-100" type="submit">{{ __('Confirm') }}</button>
                                    </div>
                                </div>
                            </form>
                        </div>
